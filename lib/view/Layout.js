    ...
    renderChildren(path, node, tabSetComponents, tabComponents, floatingWindows, splitterComponents) {
        ...
        for (const child of drawChildren) {
            if (child instanceof SplitterNode_1.SplitterNode) {
                ...
                tabSetComponents.push(React.createElement(TabSet_1.TabSet, { key: child.getId(), layout: this, path: newPath, node: child, iconFactory: this.props.iconFactory, titleFactory: this.props.titleFactory, icons: this.icons, onTabMouseEnter: this.props.onTabMouseEnter }));
