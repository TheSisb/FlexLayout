...
const TabButton = (props) => {
    ...
    return (React.createElement("div", { ref: selfRef, "data-layout-path": path, className: classNames, onMouseDown: onMouseDown, onClick: onAuxMouseClick, onAuxClick: onAuxMouseClick, onContextMenu: onContextMenu, onTouchStart: onMouseDown, onMouseEnter: handleMouseEnter, title: node.getHelpText() },
        leading,
        content,
        renderState.buttons));
};
